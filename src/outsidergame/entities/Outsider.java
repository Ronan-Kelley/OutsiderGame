...
public class Outsider extends CharacterBase {
    ...
    public Outsider(Point pos, Rectangle size, int controller) {
        super(pos, size, controller);
    ...
    public void draw(Graphics2D g) {
        ...
        if (standingSprite == null) {
            try {
                standingSprite = GraphicsUtil.makeBuffered(
                        (Image) ImageIO.read(getClass().getResourceAsStream("../resources/OutsiderStanding.png")));
            } catch (Exception e) {
        ...
        if (inAirSprite == null) {
            try {
                inAirSprite = GraphicsUtil.makeBuffered(
                        (Image) ImageIO.read(getClass().getResourceAsStream("../resources/outsiderJumping.png")));
            } catch (Exception e) {
                System.out.println("couldn't make holly into a buffered image!");
                e.printStackTrace();
            }
        ...
        if (walkingSprite1 == null) {
            try {
                walkingSprite1 = GraphicsUtil.makeBuffered(
                        (Image) ImageIO.read(getClass().getResourceAsStream("../resources/outsiderWalking1.png")));
            } catch (Exception e) {
                System.out.println("couldn't make holly into a buffered image!");
                e.printStackTrace();
            }
        ...
        if (walkingSprite2 == null) {
            try {
                walkingSprite2 = GraphicsUtil.makeBuffered(
                        (Image) ImageIO.read(getClass().getResourceAsStream("../resources/outsiderWalking2.png")));
            } catch (Exception e) {
                System.out.println("couldn't make holly into a buffered image!");
                e.printStackTrace();
            }
        ...
        if (attackingSprite == null) {
            try {
                attackingSprite = GraphicsUtil.makeBuffered(
                        (Image) ImageIO.read(getClass().getResourceAsStream("../resources/outsiderAttacking.png")));
            } catch (Exception e) {
                System.out.println("couldn't make holly into a buffered image!");
                e.printStackTrace();
            }
